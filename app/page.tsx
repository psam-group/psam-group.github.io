...
const copy = {
  en: {
    ...
    aboutText: "At the PSAM-Group (Plant Stress Analysis & Modeling), we investigate the complex mechanisms of abiotic stress in plants by combining experimental biophysics with advanced computational methods. Our goal is to understand, model, and predict plant responses to environmental challenges.",
  ...
  bg: {
    ...
    aboutText: "В PSAM-Group (Plant Stress Analysis & Modeling) изследваме сложните механизми на абиотичния стрес при растенията, като съчетаваме експериментална биофизика със съвременни изчислителни методи. Нашата цел е да разбираме, моделираме и предвиждаме реакциите на растенията към предизвикателствата на околната среда.",
...
const people = [
  ...
  },
  {
    ...
    interests: "Plant stress physiology, biological data analysis, bioinformatics, machine learning and artificial intelligence applications in biology. Particular interests include stress-response mechanisms in model systems, chlorophyll fluorescence analysis, metabolomics, physiological data interpretation, and the development of computational and data-driven approaches for biological research.",
    interestsBg: "Физиология на растителния стрес, анализ на биологични данни, биоинформатика, машинно обучение и приложения на изкуствения интелект в биологията. Специалните му интереси включват механизмите на стресовия отговор в моделни системи, анализ на хлорофилната флуоресценция, метаболомика, интерпретация на физиологични данни и разработване на изчислителни и базирани на данни подходи за биологични изследвания.",
...
export default function Home({ initialLang = "en" }: { initialLang?: "en" | "bg" }){
  ...
  return <main>
    ...
    <section className="hero" id="top"><div className="hero-copy"><p className="eyebrow">{t.eyebrow}</p><h1>{t.title}</h1><p className="intro">{t.intro}</p><a className="cta" href="#about">{t.cta}<span>↘</span></a></div><div className="science-art"><span className="axis y">FLUORESCENCE INTENSITY</span><span className="axis x">TIME →</span><svg viewBox="0 0 620 520"><defs><linearGradient id="leaf"><stop stopColor="#c3ff55"/><stop offset="1" stopColor="#26a95b"/></linearGradient><filter id="glow"><feGaussianBlur stdDeviation="8"/></filter></defs><path className="glow" d="M35 438C58 438 76 436 94 429C119 419 139 397 158 368C177 338 193 312 218 295C241 280 264 276 290 270C318 264 337 250 353 227C370 202 382 169 402 143C422 117 446 108 475 100C505 92 526 74 546 52C563 34 578 27 590 25"/><path className="curve" d="M35 438C58 438 76 436 94 429C119 419 139 397 158 368C177 338 193 312 218 295C241 280 264 276 290 270C318 264 337 250 353 227C370 202 382 169 402 143C422 117 446 108 475 100C505 92 526 74 546 52C563 34 578 27 590 25"/><path className="leaf" d="M319 427C351 295 435 232 578 219c-3 127-83 206-259 208Z"/><path className="vein" d="M331 415C389 355 449 300 560 239M389 356C378 347 369 336 362 326M424 324C459 334 495 348 526 358"/></svg><div className="signal"><b>O–J–I–P</b><span>fast fluorescence transient</span></div></div><p className="affiliation">{t.aff}<br/>{t.city}</p></section>
    ...
    <section className="contact" id="contact"><div><p className="eyebrow">PSAM × COLLABORATION</p><h2>{t.ct}</h2><p className="contact-intro">{t.cp}</p></div><div className="contact-details"><div><span>{lang === "en" ? "Institution" : "Институция"}</span><p>{lang === "en" ? "Institute of Plant Physiology and Genetics, Bulgarian Academy of Sciences" : "Институт по физиология на растенията и генетика, Българска академия на науките"}</p></div><div><span>{lang === "en" ? "Address" : "Адрес"}</span><a href="https://www.google.com/maps/place//data=!4m2!3m1!1s0x40aa85d0722fffff:0x625154d7eb32ad37?sa=X&ved=1t:8290&ictx=111" target="_blank" rel="noreferrer">{lang === "en" ? 'Block 21, Geo Milev, ul. "Akad. Georgi Bonchev", 1113 Sofia, Bulgaria' : 'Блок 21, кв. Гео Милев, ул. „Акад. Георги Бончев“, 1113 София, България'} ↗</a></div><div><span>{lang === "en" ? "Institutional email" : "Служебна електронна поща"}</span><a href="mailto:aleksandrov@bio21.bas.bg">aleksandrov@bio21.bas.bg ↗</a></div><div><span>{lang === "en" ? "Additional email" : "Допълнителна електронна поща"}</span><a href="mailto:aleksandrov@gbg.bg">aleksandrov@gbg.bg ↗</a></div></div></section><footer><Mark/><p>© 2026 PSAM-Group<br/>IPPG · BAS</p><a href="#top">Back to top ↑</a></footer>
  </main>
}
